              ...
              <li className="dCard">
                ...
                <div className="dCardtext">
                  <div className="dCardScore">
                    <span className="dCardStar">{r.star}</span>
                    <span>
                      <StarScore star={r.star} />
                    </span>
                    <span>({r.ratecount})</span>
                  </div>
                  <div className="dCardTitle">{r.title}</div>
                  <div className="dCardTeacher">{r.teacher}</div>
                  ...
                  <div className="dCardPrice">NT$ {r.special}</div>
                </div>
              </li>
            </Link>
          );
